        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link as={Link} to="yugioh-fm-tools/duel-calculator">
                Duel Points Calculator
              </Nav.Link>
              <Nav.Link as={Link} to="yugioh-fm-tools/duel-common-strats">
                Duel Common Strats
              </Nav.Link>
              <Nav.Link as={Link} to="yugioh-fm-tools/guardian-star">
                Guardian Star Chart
              </Nav.Link>
