    ...
    return (
      <>
        ...
        <InputGroup.Text style={{ width: "13%", paddingRight: "40px" }}>
          {calcPts(id) < 0
            ? "−" + ("0000" + Math.abs(calcPts(id))).slice(-2)
            : "+" + ("00" + calcPts(id)).slice(-2)}
        </InputGroup.Text>
      </>
    );
  }
            ...
            >
              <Button
                ...
                onClick={() =>
                  handleInputChange(
                    "lifePoints",
                    values.lifePoints + interval.value,
                  )
                }
              >
                {interval.label}
  ...
  return (
    <>
      <Container>
        ...
        <p>
          {" "}
          This calculator was created based on the information from this{" "}
          <a href="https://www.neoseeker.com/forums/3085/t2018541-calculating-duel-rank/">
            guide
          </a>
          . If there is anything you don't understand, please read it!{" "}
        </p>
        <p>
          When you can no longer lose any more points for the given duel
          statistic, the form will turn green.
        </p>
        <p>
          When the duel is over, be sure to click the reset button on the top
          right.
        </p>
        <Row>
          <Col>
            <InputGroup className="yfmcalc-input">
              ...
              <InputGroup.Text>
                50 + ({totalPts >= 0 ? "+" + totalPts : totalPts}) ={" "}
                {50 + totalPts}{" "}
              </InputGroup.Text>
              <InputGroup.Text>
                <strong>{calcGrade()}</strong>
              </InputGroup.Text>
            </InputGroup>
          </Col>
    ...
    <>
      <Container>
        <h3 style={{ textAlign: "center" }}>
          {" "}
          Duel Statistics & Rewards Help{" "}
        </h3>
        <p>
          Since this may be a bit unclear, here are descriptions of the
          requirements for each duel statistic:
        </p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <strong>for your opponent</strong>.
              </td>
            </tr>
            <tr>
              <td>Effective Attacks</td>
              <td>
                When you attack your opponent's card, and deal life-point
                damage.
              </td>
            </tr>
            <tr>
              ...
              <td>
                When your opponent attacks a face-down card, and your card
                survives.
              </td>
            </tr>
            <tr>
              <td>Face Downs</td>
              <td>
                When you play any card (Magic, Trap, or Monster) face down.
              </td>
            </tr>
            <tr>
              <td>Fusions</td>
              <td>
                The number of cards you fused together (failed fusions do not
                count). Multiple fusions for a single card will count each
                individual fusion.
              </td>
            </tr>
            <tr>
              <td>Magics</td>
              <td>When you activate a non-equip magic card.</td>
            </tr>
            <tr>
              <td>Equips</td>
              <td>
                When you use a magic equip card on one of your monsters (it must
                be a valid equip).
              </td>
            </tr>
            <tr>
              <td>Traps</td>
              <td>
                When you set a face-down trap card, and it is then triggered by
                an opponent's attack (you can't manually flip the card yourself)
              </td>
            </tr>
          </tbody>
        </Table>
        ...
        <Row>
          ...
          <Col>
            <p>
              There are only <strong>three tiers</strong> of duel rewards, each
              tier will provide the same drop tables for <strong>all</strong>{" "}
              duelists.{" "}
            </p>
            <p>
              This is why getting an S-TEC is unnecessary and why you should be
              going for an A-TEC instead.{" "}
            </p>
      ...
      <div className="yfmc-body" data-bs-theme="dark">
        ...
        <div className="App">
          <header className="App-header">
            <Image className="App-logo" alt="react-logo" src="logo.svg" />
          </header>
        </div>
      </div>
    </>
