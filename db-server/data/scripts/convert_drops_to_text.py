# This script was used to convert my enumerated data to text, it's not needed
# for anything anymore

OUTPUT_FILE = 'card_drop_out.csv'
INPUT_FILE = 'card_drop.csv'
...
with open(INPUT_FILE) as in_f:
    ...
    for line in in_f:
        spl = line.split(',')
        duelist_id = int(spl[0])
        grade_id = int(spl[1])
        card_id = int(spl[2])
        weight = int(spl[3])
        out_f.write(f"\"{duelist_dict[duelist_id]}\",\"{grade_dict[grade_id]}\",\"{card_dict[card_id]}\",{weight}\n")
out_f.close()
